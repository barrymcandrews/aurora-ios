...
@IBDesignable class SegmentedControl: UIControl {
    ...
    var items: [String] = ["Hue", "Components", "Pattern"] {
        didSet {
            setupLabels()
        }
    }
    ...
    override func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        if calculatedIndex != nil && !Hero.shared.transitioning {
    ...
    func displayNewSelectedIndex(){
        ...
        UIView.animate(withDuration: 0.5, delay: 0.0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.7, options: .allowAnimatedContent, animations: {
    ...
    func addIndividualItemConstraints(items: [UIView], mainView: UIView, padding: CGFloat) {
        ...
        for (index, button) in items.enumerated() {
            ...
            // Top and bottom constraints apply to all labels
